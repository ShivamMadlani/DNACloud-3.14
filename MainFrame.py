...
class MainWindow(QMainWindow):
    ...
    def showUser_Manual(self):
        webbrowser.open("https://drive.google.com/file/d/1Skru68vl41RhrLqnGBLq38NL-0ojp6m4/view", new=2)
    ...
    def showCredits(self):
        webbrowser.open("https://drive.google.com/file/d/1FNmoNd2rE4ChLR1-1nGbJd-CVq7vYAKV/view", new=2)
